...
//        });
//
//        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("main/java/icons/1.png"));
...
//        p1.add(l2);
//
//        ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("main/java/icons/video.png"));
...
//        p1.add(l5);
//
//        ImageIcon i11 = new ImageIcon(ClassLoader.getSystemResource("main/java/icons/phone.png"));
...
//        p1.add(l6);
//
//        ImageIcon i14 = new ImageIcon(ClassLoader.getSystemResource("main/java/icons/3icon.png"));
...
//        f1.setUndecorated(true);
    ...
    private void handleSentUI(String out){
